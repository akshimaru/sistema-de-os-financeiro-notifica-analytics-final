...
import { Moon, Sun, Bell, Mail, Key, UserPlus, ArrowLeft, Edit, Settings, Monitor, User } from 'lucide-react';
...
import { ConfigurarSistemaModal } from '../components/ConfigurarSistemaModal';
...
export function Perfil() {
  ...
  const [showConfigurarSistemaModal, setShowConfigurarSistemaModal] = useState(false);
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-600">
                <button
                  onClick={() => setShowConfigurarSistemaModal(true)}
                  className="w-full px-4 py-2 bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors flex items-center justify-center space-x-2"
                >
      ...
      <ConfigurarSistemaModal
        isOpen={showConfigurarSistemaModal}
        onClose={() => setShowConfigurarSistemaModal(false)}
        onSuccess={loadUserData}
      />
    </div>
  );
